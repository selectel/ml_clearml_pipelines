...
args = {
    'dataset_task_id': '[ЭТО ID-шник задачи, которая была создана в ClearML после выполнения скрипта step1_dataset_artifact.py]',
    'dataset_url': '',
    'random_state': 42,
    'test_size': 0.2,
}
...
if args['dataset_task_id']:
    ...
    print(
        'Input task id={} artifacts {}'.format(
            ...
            list(dataset_upload_task.artifacts.keys())
        )
    )
